# Compressed Website Video Manifest

Generated from `demo_videos/` for lazy-loaded method-card media.

Compression settings: max width 640 px, 15 fps, no audio, H.264 MP4, CRF 32, fast-start, capped at 12 seconds.

FFHFlow and CEDex remain static because the available direct media was either mostly slide/title content or no official direct demo video was found. PartDexTOG uses a cropped method figure from the paper PDF because no official project page or demo video was found after search.

| Paper | Source | Website asset | Compressed | Note |
| --- | --- | --- | ---: | --- |
| ContactGen | `demo_videos/contactgen/contactgen_contact_map.mp4` | `assets/videos/contactgen_demo.mp4` | 128 KB | object-centric contact map clip |
| DP3 | `demo_videos/dp3/dp3_teaser.mp4` | `assets/videos/dp3_demo.mp4` | 211 KB | teaser clip |
| DexDiffuser | `demo_videos/dexdiffuser/dexdiffuser_toy_airplane.mp4` | `assets/videos/dexdiffuser_demo.mp4` | 126 KB | toy-plane grasp clip, intro skipped |
| DexHandDiff | `demo_videos/dexhanddiff/dexhanddiff_pen_goal_adaptive.mp4` | `assets/videos/dexhanddiff_demo.mp4` | 13 KB | goal-adaptive pen reorientation clip |
| FlowPolicy | `demo_videos/flowpolicy/flowpolicy_adroit_door.mp4` | `assets/videos/flowpolicy_demo.mp4` | 74 KB | Adroit door clip |
